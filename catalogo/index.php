        ...
        <div id="productsContainer" class="container center-align">
            ...
            <div id="prodRowRen1" class="row">
                <div class="col s12 m12 l3">
                    <div id="prodCard" class="card">
                        <div class="card-content">
                            ...
                            <a href="../assets/doc/BROCAL_84A.pdf" target="_blank" class="btn btn-download tooltipped" data-position="bottom" data-tooltip="Ficha Técnica">
                                <svg style="width:24px;height:24px;vertical-align:middle;margin-bottom:3px" viewBox="0 0 24 24">
                ...
                <div class="col s12 m12 l3">
                    <div id="prodCard" class="card">
                        <div class="card-content">
                            <img id="prodImg" class="responsive-img materialboxed" src="../assets/img/catalogo/profico_cfe2.jpg" alt="Profico84B">
                ...
                <div class="col s12 m12 l3">
                    <div id="prodCard" class="card">
                        <div class="card-content">
                            <img id="prodImg" class="responsive-img materialboxed" src="../assets/img/catalogo/profico_cfe3.jpg" alt="Profico84B">
                ...
                <div class="col s12 m12 l3">
                    <div id="prodCard" class="card">
                        <div class="card-content">
                            ...
                            <p class="prodName">REGISTRO 65X65X60</p>
                            <p class="skillName">(TAPA POLIMERICA, CUERPO EN FIBRA DE VIDRIO)</p>
                            <div id="rowLabel" class="row">
                                <div class="col s6 l6 m6">
                                    <label id="prodCategoria" style="background-color: #989898;">Registros</label>
                            ...
                            <a href="../assets/doc/REGISTRO_656560_apilable.pdf" target="_blank" class="btn btn-download tooltipped" data-position="bottom" data-tooltip="Ficha Técnica">
                                <svg style="width:24px;height:24px;vertical-align:middle;margin-bottom:3px" viewBox="0 0 24 24">
                                    <path fill="#fff" d="M14,2L20,8V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2H14M18,20V9H13V4H6V20H18M12,19L8,15H10.5V12H13.5V15H16L12,19Z"></path>
                                </svg>
                            </a>
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="row">
                                            <div class="col s9 m9 l9">
                                                <h6 class="coticeTitleProduct">Producto:</h6>
                                                <p class="coticeTextProduct">REGISTRO 65X65X60 CON TAPA POLIMERICA Y CUERPO EN FIBRA DE VIDRIO (APILABLE)</p>
                                            </div>
                                            <div class="col s3 m3 l3">
                                                <div class="input-data">
                                                    <input id="inputNumber" placeholder="Cantidad" name="cantidad" min="1" max="999" patterns="[0-9]{1,5}" type="number" required>
                                        ...
                                        <div class="input-field">
                                            <input id="inputData" type="hidden" value='REGISTRO 65X65X60 CON TAPA POLIMERICA Y CUERPO EN FIBRA DE VIDRIO (APILABLE)' name="producto" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="row">
                                            <div class="col s9 m9 l9">
                                                <h6 class="coticeTitleProduct">Producto:</h6>
                                                <p class="coticeTextProduct">REGISTRO MEGA 24"X36"X24" CON MARCO Y TAPA POLIMERICA Y CUERPO DE FIBRA VIDRIO</p>
                                            </div>
                                            <div class="col s3 m3 l3">
                                                <div class="input-data">
                                                    <input id="inputNumber" placeholder="Cantidad" name="cantidad" min="1" max="999" patterns="[0-9]{1,5}" type="number" required>
                                        ...
                                        <div class="input-field">
                                            <input id="inputData" type="hidden" value='REGISTRO MEGA 24"X36"X24" CON MARCO Y TAPA POLIMERICA Y CUERPO DE FIBRA VIDRIO' name="producto" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                ...
                <div class="col s12 m12 l3">
                    <div id="prodCard" class="card">
                        <div class="card-content">
                            ...
                            <p class="skillName">(17X30X24 CUERPO DE FIBRA VIDRIO)</p>
                            <div id="rowLabel" class="row">
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="row">
                                            <div class="col s9 m9 l9">
                                                <h6 class="coticeTitleProduct">Producto:</h6>
                                                <p class="coticeTextProduct">REGISTRO SUPER 17"X30x24" CON MARCO Y TAPA POLIMERICA Y CUERPO DE FIBRA VIDRIO</p>
                                            </div>
                                            <div class="col s3 m3 l3">
                                                <div class="input-data">
                                                    <input id="inputNumber" placeholder="Cantidad" name="cantidad" min="1" max="999" patterns="[0-9]{1,5}" type="number" required>
                                        ...
                                        <div class="input-field">
                                            <input id="inputData" type="hidden" value='REGISTRO SUPER 17"X30x24" CON MARCO Y TAPA POLIMERICA Y CUERPO DE FIBRA VIDRIO' name="producto" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                ...
                <div class="col s12 m12 l3">
                    <div id="prodCard" class="card">
                        <div class="card-content">
                            ...
                            <p class="skillName">(REJILLA ANCHO DE 20CM X 20CM X 1M)</p>
                            <div id="rowLabel" class="row">
                                <div class="col s6 l6 m6">
                            ...
                            <a href="../assets/doc/CANAL_DE_DESAGÜE_CON_REJILLA_ANCHO_DE_20CM_X_20CM_X_1M.pdf" target="_blank" class="btn btn-download tooltipped" data-position="bottom" data-tooltip="Ficha Técnica">
                                <svg style="width:24px;height:24px;vertical-align:middle;margin-bottom:3px" viewBox="0 0 24 24">
                                    <path fill="#fff" d="M14,2L20,8V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2H14M18,20V9H13V4H6V20H18M12,19L8,15H10.5V12H13.5V15H16L12,19Z"></path>
                                </svg>
                            </a>
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="row">
                                            <div class="col s9 m9 l9">
                                                <h6 class="coticeTitleProduct">Producto:</h6>
                                                <p class="coticeTextProduct">CANAL DE DESAGÜE CON REJILLA ANCHO DE 20CM X 20CM X 1M (CANALETA DE CONCRETO POLIMERICO 1 m)</p>
                                            </div>
                                            <div class="col s3 m3 l3">
                                                <div class="input-data">
                                                    <input id="inputNumber" placeholder="Cantidad" name="cantidad" min="1" max="999" patterns="[0-9]{1,5}" type="number" required>
                                        ...
                                        <div class="input-field">
                                            <input id="inputData" type="hidden" value='CANAL DE DESAGÜE CON REJILLA ANCHO DE 20CM X 20CM X 1M (CANALETA DE CONCRETO POLIMERICO 1 m)' name="producto" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
