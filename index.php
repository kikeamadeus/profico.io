...
<body>
    ...
    <section id="introSection">
        <div id="introContainer" class="container">
            <h2 class="introTitle">Diseñamos el futuro</h2>
            <h4 class="introSubtitle">Con más de 8 años de experiencia fabricamos productos de fibra de vidrio y concreto polimérico como registros eléctricos, registros sanitarios, brocales además de mobiliario urbano.</h4>
            <a href="https://wa.me/18712921525?text=Buenas%20tardes" target="_blank" class="btn btn-intro modal-trigger">Cotizar ahora</a>
        </div>
    </section>

    <section id="usSection">
        <div id="usContainer" class="container center-align">
            <div id="usRow" class="row">
                <div class="col s12 m12 l7">
                    <img id="usImg" class="responsive-img" src="assets/img/profico_diseno.jpg" alt="Nosotros">
                </div>
                <div class="col s12 m12 l5">
                    <h2 class="usTitle">Diseño Personalizado</h2>
                    <p class="usText">Todos nuestros productos cuentan con diseño y medidas personalizadas en la cual podemos inclusive insertar el logo de tu empresa. Además realizamos la instalación de todo tus productos fabricados. </p>
                    <a href="nosotros" class="btn btn-Info modal-trigger">Más de nosotros</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="prodSection">
        <div id="prodContainer" class="container center-align">
            <h1 class="prodTitle">Más Vendidos</h1>
            <div id="prodRowRen1" class="row">
                ...
                <div class="col s12 m12 l3">
                    <div id="prodCard" class="card">
                        <div class="card-content">
                            <img id="prodImg" class="responsive-img materialboxed" src="assets/img/catalogo/profico_3.jpg" alt="Profico 3">
                ...
                <div class="col s12 m12 l3">
                    <div id="prodCard" class="card">
                        <div class="card-content">
                            <img id="prodImg" class="responsive-img materialboxed" src="assets/img/catalogo/profico_4.jpg" alt="Profico 4">
            ...
            <div id="prodRowRen2" class="row">
                        ...
                        <form action="accion/sendcotice.php" method="POST" class="center-align">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    ...
                                    <div class="input-field">
                                        <input id="inputData" type="hidden" value='REGISTRO CIRCULAR TIPO CUBETA COLOR AMARILLO CON MARCO Y TAPA CONCRETO POLIMERICO CON LEYENDA "ALUMBRADO"' name="producto" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="col s12 m12 l3">
                    <div id="prodCard" class="card">
                        <div class="card-content">
                            <img id="prodImg" class="responsive-img materialboxed" src="assets/img/catalogo/profico_7.jpg" alt="Profico 7">
                            <p class="prodName">REGISTRO TIPO CUBETA</p>
